...
(function (global, factory) {
    ...
    function position(element, parent) {
        parent =
            parent || toNode(element).offsetParent || toWindow(element).document.documentElement;
    ...
    */
        ...
        UIkit.prototype._callWatches = function () {
            ...
            _frames._watch = fastdom.read(function () {
                ...
                for (var key in computed) {
                    ...
                    if (
                        watch &&
                        ((initital && immediate) || (hasPrev && !isEqual(prev, this$1[key])))
                    ) {
    ...
    var Accordion = {
        ...
        events: [
            {
                ...
                handler: function (e) {
                    e.preventDefault();
                    this.toggle(
                        index($$(this.targets + ' ' + this.$props.toggle, this.$el), e.current)
                    );
                },
            },
        ],
        ...
        methods: {
            toggle: function (item, animate) {
                ...
                items.forEach(function (el) {
                    return this$1.toggleElement(el, !hasClass(el, this$1.clsOpen), function (
                        el,
                        show
                    ) {
                ...
                read: function (ref) {
                    ...
                    return {
                        scrolled: this.parallax
                            ? scrolledOver(this.$el, height$1 ? height$1 - height(this.$el) : 0) *
            ...
            read: function (ref) {
                ...
                image &&
                    image.then(function (img) {
                        return (
                            img && img.currentSrc !== '' && setSrcAttrs(this$1.$el, currentSrc(img))
                        );
                    });
            },
        ...
        update: [
            {
                read: function (ref, type) {
                    ...
                    this.top =
                        Math.max(toFloat(parseProp('top', this)), this.topOffset) - this.offset;
    ...
    var toggle = {
        ...
        events: [
...

            {
                ...
                filter: function () {
                    return (
                        includes(this.mode, 'click') || (hasTouch && includes(this.mode, 'hover'))
                    );
                },
    ...
    var lightbox = {
        ...
        methods: {
            show: function (index) {
                ...
                this.panel =
                    this.panel ||
                    this.$create('lightboxPanel', assign({}, this.$props, { items: items }));
    ...
    function getElLeft(el, list) {
        return (
            (position(el).left + (isRtl ? offset(el).width - offset(list).width : 0)) *
            (isRtl ? -1 : 1)
        );
    }
    ...
    var slider = {
        ...
        update: {
            write: function () {
                ...
                $$('[' + this.attrItem + '],[data-' + this.attrItem + ']', this.$el).forEach(
                    function (el) {
